// EmuLab — interim Expo shell for retro-emulator-ios.
//
// Current purpose: run the PLAN.md §10.3 ARM11 interpreter spike on real
// hardware via an EAS-built dev client. The number that decides release
// sequencing is this benchmark's output on a physical iPhone 15.
...
export default function App() {
  ...
  async function share() {
    if (!rawJson) return;
    await Share.share({
      message: `ARM11 spike on ${deviceLabel}:\n${rawJson}`,
    });
  }
...
const styles = StyleSheet.create({
  ...
  scroll: { padding: 20, paddingTop: 80, paddingBottom: 60 },
