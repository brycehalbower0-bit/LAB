...
MGBA_EXPORT const char* const gitCommit = "vendored-0.10.5";
MGBA_EXPORT const char* const gitCommitShort = "0.10.5";
MGBA_EXPORT const char* const gitBranch = "vendored";
